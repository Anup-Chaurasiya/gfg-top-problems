<h2><a href="https://www.geeksforgeeks.org/problems/subsets-1613027340/0?category=&utm_source=inf&utm_medium=inf%252Fcampaign%2B&utm_campaign=codein10_subset_YT">Subsets</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a set of positive integers, find <strong>all its subsets</strong>.</span></p>
